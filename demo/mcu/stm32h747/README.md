# Picovoice STM32747I-DISCO Demo (Multiple languages)
...
3. Copy the contents of the arrays inside the `.h` header files and update the `keyword_array` and `context_array` values in [/stm32h747i-disco/CM7/Inc/pv_params.h](./stm32h747i-disco/CM7/Inc/pv_params.h) in the language section for which the model is trained.
