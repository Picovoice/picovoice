Pod::Spec.new do |s|
    ...
    s.dependency 'Porcupine-iOS', '~> 2.0.0', :podspec => 'https://raw.githubusercontent.com/Picovoice/porcupine/v2.1-ios/binding/ios/Porcupine-iOS.podspec'
    s.dependency 'Rhino-iOS', '~> 2.0.0', :podspec => 'https://raw.githubusercontent.com/Picovoice/rhino/v2.1-ios/binding/ios/Rhino-iOS.podspec'
