...
1. Copy the content of `output_c_array.txt` and update the `keyword_array` and `context_array` values in [/stm32h735g-dk/Inc/pv_params.h](./stm32h735g-dk/Inc/pv_params.h).
